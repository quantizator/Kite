 ...
 * @author dmste
 */
public class DocumentFieldMementoBuilder extends AbstractMementoBuilder<DocumentFieldDefinition> {
    ...
    public DocumentFieldMementoBuilder(DocumentType documentType,
