databaseChangeLog() {
    changeSet(id: 'create-schema', author: 'dmste') {
        sql(stripComments: true, splitStatements: false, endDelimiter: ';') {
            "create schema if not exists applications"
        }
    }
    changeSet(id: 'applications-core-no-references', author: 'dmste') {
    ...
    changeSet(id: 'applications-core-foreignkeys', author: 'dmste') {
    ...
    changeSet(id: 'applications-core-add-documentid', author: 'dmste') {
    ...
    changeSet(id: 'applications-core-loosen-constraints-1', author: 'dmste') {
    ...
    changeSet(id: 'individuals-add-passport-data', author: 'dmste') {
